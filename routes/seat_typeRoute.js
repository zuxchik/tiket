...
const { seatTypeValidation } = require("../seat_type/seat_type.validetion")
 ...
 */
seatTypeRouter.post("/create_SeatTypof", ValidateSchema(seatTypeValidation), create_SeatTypof);
